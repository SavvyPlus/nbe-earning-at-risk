...
def lambda_handler(event, context):
    ...
    bucket_output = '007-spot-price-forecast-physical'
    spot_price_df_list = []
    ...
    print(df)
    df.to_parquet(f"s3://{bucket_output}/projects/NextBusinessEnergy/spot_price_by_sim/{run_id}/{event['sim_index']}.parquet", index=False)
